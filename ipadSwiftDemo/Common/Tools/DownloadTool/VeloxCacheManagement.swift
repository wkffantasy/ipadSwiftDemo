...
public class VeloxCacheManagement {
    ...
    public static func fileExistWithName(name: String, directory _: String?) -> Bool {
    ...
    public static func createDirectoryNamed(name _: URL) -> Bool {
    ...
    public static func isFileDownloadingWithURL(url: URL, progress: ((CGFloat, VeloxDownloadInstance) -> Void)?) -> Bool {
        return self.isFileDownloadingWithURL(url: url, progress: progress, completion: nil)
    }

    public static func isFileDownloadingWithURL(url: URL, progress: ((CGFloat, VeloxDownloadInstance) -> Void)?, completion: ((Bool) -> Void)?) -> Bool {
        var flag = false
    ...
    public static func deleteFileForURL(url: URL, directory _: String?) -> Bool {
